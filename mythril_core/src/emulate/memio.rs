    ...
    ($out:ident, $value:expr, $type:ty) => {
        {
            ...
            $out.try_extend_from_slice(&data)
                .map_err(|_| Error::InvalidValue(
                    "Invalid length with reading register".into()
                ))?;
        }
    }
}
...
fn read_register_value(
    ...
    match register {
        ...
        iced_x86::Register::SPL => read_register!(res, vmcs.read_field(vmcs::VmcsField::GuestRsp)?, u8),
        iced_x86::Register::SP  => read_register!(res, vmcs.read_field(vmcs::VmcsField::GuestRsp)?, u16),
        iced_x86::Register::ESP => read_register!(res, vmcs.read_field(vmcs::VmcsField::GuestRsp)?, u32),
        iced_x86::Register::RSP => read_register!(res, vmcs.read_field(vmcs::VmcsField::GuestRsp)?, u64),
...
fn do_mmio_read(
    ...
    match instr.op0_kind() {
        iced_x86::OpKind::Register => {
            match instr.op_register(0) {
                iced_x86::Register::AL   => write_register!(vm, vcpu, addr, guest_cpu.rax, u8,  !0xff),
                iced_x86::Register::AX   => write_register!(vm, vcpu, addr, guest_cpu.rax, u16, !0xffff),
                iced_x86::Register::EAX  => write_register!(vm, vcpu, addr, guest_cpu.rax, u32, !0xffffffff),
                iced_x86::Register::RAX  => write_register!(vm, vcpu, addr, guest_cpu.rax, u64, 0x00),

                iced_x86::Register::BL   => write_register!(vm, vcpu, addr, guest_cpu.rbx, u8,  !0xff),
                iced_x86::Register::BX   => write_register!(vm, vcpu, addr, guest_cpu.rbx, u16, !0xffff),
                iced_x86::Register::EBX  => write_register!(vm, vcpu, addr, guest_cpu.rbx, u32, !0xffffffff),
                iced_x86::Register::RBX  => write_register!(vm, vcpu, addr, guest_cpu.rbx, u64, 0x00),

                iced_x86::Register::CL   => write_register!(vm, vcpu, addr, guest_cpu.rcx, u8,  !0xff),
                iced_x86::Register::CX   => write_register!(vm, vcpu, addr, guest_cpu.rcx, u16, !0xffff),
                iced_x86::Register::ECX  => write_register!(vm, vcpu, addr, guest_cpu.rcx, u32, !0xffffffff),
                iced_x86::Register::RCX  => write_register!(vm, vcpu, addr, guest_cpu.rdx, u64, 0x00),

                iced_x86::Register::DL   => write_register!(vm, vcpu, addr, guest_cpu.rdx, u8,  !0xff),
                iced_x86::Register::DX   => write_register!(vm, vcpu, addr, guest_cpu.rdx, u16, !0xffff),
                iced_x86::Register::EDX  => write_register!(vm, vcpu, addr, guest_cpu.rdx, u32, !0xffffffff),
                iced_x86::Register::RDX  => write_register!(vm, vcpu, addr, guest_cpu.rdx, u64, 0x00),

                iced_x86::Register::R8L => write_register!(vm, vcpu, addr, guest_cpu.r8, u8,  !0xff),
                iced_x86::Register::R8W => write_register!(vm, vcpu, addr, guest_cpu.r8, u16, !0xffff),
                iced_x86::Register::R8D => write_register!(vm, vcpu, addr, guest_cpu.r8, u32, !0xffffffff),
                iced_x86::Register::R8  => write_register!(vm, vcpu, addr, guest_cpu.r8, u64, 0x00),

                iced_x86::Register::R9L => write_register!(vm, vcpu, addr, guest_cpu.r9, u8,  !0xff),
                iced_x86::Register::R9W => write_register!(vm, vcpu, addr, guest_cpu.r9, u16, !0xffff),
                iced_x86::Register::R9D => write_register!(vm, vcpu, addr, guest_cpu.r9, u32, !0xffffffff),
                iced_x86::Register::R9  => write_register!(vm, vcpu, addr, guest_cpu.r9, u64, 0x00),

                iced_x86::Register::R10L => write_register!(vm, vcpu, addr, guest_cpu.r10, u8,  !0xff),
                iced_x86::Register::R10W => write_register!(vm, vcpu, addr, guest_cpu.r10, u16, !0xffff),
                iced_x86::Register::R10D => write_register!(vm, vcpu, addr, guest_cpu.r10, u32, !0xffffffff),
                iced_x86::Register::R10  => write_register!(vm, vcpu, addr, guest_cpu.r10, u64, 0x00),

                iced_x86::Register::R11L => write_register!(vm, vcpu, addr, guest_cpu.r11, u8,  !0xff),
                iced_x86::Register::R11W => write_register!(vm, vcpu, addr, guest_cpu.r11, u16, !0xffff),
                iced_x86::Register::R11D => write_register!(vm, vcpu, addr, guest_cpu.r11, u32, !0xffffffff),
                iced_x86::Register::R11  => write_register!(vm, vcpu, addr, guest_cpu.r11, u64, 0x00),

                iced_x86::Register::R12L => write_register!(vm, vcpu, addr, guest_cpu.r12, u8,  !0xff),
                iced_x86::Register::R12W => write_register!(vm, vcpu, addr, guest_cpu.r12, u16, !0xffff),
                iced_x86::Register::R12D => write_register!(vm, vcpu, addr, guest_cpu.r12, u32, !0xffffffff),
                iced_x86::Register::R12  => write_register!(vm, vcpu, addr, guest_cpu.r12, u64, 0x00),

                iced_x86::Register::R13L => write_register!(vm, vcpu, addr, guest_cpu.r13, u8,  !0xff),
                iced_x86::Register::R13W => write_register!(vm, vcpu, addr, guest_cpu.r13, u16, !0xffff),
                iced_x86::Register::R13D => write_register!(vm, vcpu, addr, guest_cpu.r13, u32, !0xffffffff),
                iced_x86::Register::R13  => write_register!(vm, vcpu, addr, guest_cpu.r13, u64, 0x00),

                iced_x86::Register::R14L => write_register!(vm, vcpu, addr, guest_cpu.r14, u8,  !0xff),
                iced_x86::Register::R14W => write_register!(vm, vcpu, addr, guest_cpu.r14, u16, !0xffff),
                iced_x86::Register::R14D => write_register!(vm, vcpu, addr, guest_cpu.r14, u32, !0xffffffff),
                iced_x86::Register::R14  => write_register!(vm, vcpu, addr, guest_cpu.r14, u64, 0x00),

                iced_x86::Register::R15L => write_register!(vm, vcpu, addr, guest_cpu.r15, u8,  !0xff),
                iced_x86::Register::R15W => write_register!(vm, vcpu, addr, guest_cpu.r15, u16, !0xffff),
                iced_x86::Register::R15D => write_register!(vm, vcpu, addr, guest_cpu.r15, u32, !0xffffffff),
                iced_x86::Register::R15  => write_register!(vm, vcpu, addr, guest_cpu.r15, u64, 0x00),

                iced_x86::Register::DIL => write_register!(vm, vcpu, addr, guest_cpu.rdi, u8,  !0xff),
                iced_x86::Register::DI  => write_register!(vm, vcpu, addr, guest_cpu.rdi, u16, !0xffff),
                iced_x86::Register::EDI => write_register!(vm, vcpu, addr, guest_cpu.rdi, u32, !0xffffffff),
                iced_x86::Register::RDI => write_register!(vm, vcpu, addr, guest_cpu.rdi, u64, 0x00),

                iced_x86::Register::SIL => write_register!(vm, vcpu, addr, guest_cpu.rsi, u8,  !0xff),
                iced_x86::Register::SI  => write_register!(vm, vcpu, addr, guest_cpu.rsi, u16, !0xffff),
                iced_x86::Register::ESI => write_register!(vm, vcpu, addr, guest_cpu.rsi, u32, !0xffffffff),
                iced_x86::Register::RSI => write_register!(vm, vcpu, addr, guest_cpu.rsi, u64, 0x00),

                register => return Err(Error::InvalidValue(
                    format!("mmio read into invalid register '{:?}'", register)
                ))
            }
        },
        _ => return Err(Error::NotSupported)
...
pub fn handle_ept_violation(
    ...
    let addr = memory::GuestPhysAddr::new(vcpu
        .vmcs
